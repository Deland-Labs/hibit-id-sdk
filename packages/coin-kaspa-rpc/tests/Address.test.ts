...
describe("Address Tests", () => {
    const addressCases = [
        ...
        },
        {
            address: new Address(
                ...
                AddressVersion.PubKeyECDSA,
                new Uint8Array([
                    186, 1, 252, 95, 78, 157, 152, 121, 89, 156, 105, 163, 218, 253, 184,
                    53, 167, 37, 94, 95, 46, 147, 78, 147, 34, 236, 211, 175, 25, 10, 176,
                    246, 14,
                ])
            ),
            expected:
        ...
        },
        {
            address: new Address(
                ...
                AddressVersion.PubKey,
                new Uint8Array([
                    95, 255, 60, 77, 161, 143, 69, 173, 205, 212, 153, 228, 70, 17, 233,
                    255, 241, 72, 186, 105, 219, 60, 78, 162, 221, 217, 85, 252, 70, 165,
                    149, 34,
                ])
            ),
            expected:
    ...
    it("should throw errors for invalid addresses", () => {
        ...
        expect(() =>
            Address.fromString(
                "kaspa:qqqqqqqqqqqqq|qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e"
            )
        ).toThrow(Error);
        expect(() =>
            Address.fromString(
