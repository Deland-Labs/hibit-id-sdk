...
export interface TransactionPayload {
  ...
  messages: TransactionPayloadMessage[] // (array of messages): 1-4 outgoing messages from the wallet contract to other accounts. All messages are sent out in order, however the wallet cannot guarantee that messages will be delivered and executed in same order.
}
