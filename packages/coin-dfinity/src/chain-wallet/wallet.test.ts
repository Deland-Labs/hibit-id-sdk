...
const publicKeyHex = '04190ca1014addc5e6e19f18ffa6af682f9e01b00a88afa713d493acc5075e0391c685568f9b1bfd2cea15e9fda1793eb75517a5c946d4be80acd21020052771cd';
...
test('sign', async () => {
  ...
  expect(Buffer.from(signature).toString('hex')).toBe('3dfe32750ce59b403d60126ad3bcf8ff8766419c96c418d6e546edb5b9e24484434e2ee1f4b78b6a69417ece4646de4ad79ddfc5e1f1694ad2523761ca6aa2b6');

  // verify signature with public key
  const publicKey = identity.getPublicKey();
  expect(secp256k1.verify(Buffer.from(signature), Buffer.from(hash), Buffer.from(publicKey.rawKey)))
    .toBe(true);
});
...
test('sign wallet request', async () => {
  ...
  const signature = await identity.sign(messageBytes);
  expect(Buffer.from(signature).toString('hex')).toBe('67c2a4c5c17fb8ff54fdf7f6b6f4fe1f47f9274ad8fb2f924e2527e712bd765966b614426b7d10d597158403a58394bd32307cc501260424d9c473bfac5382f6');
